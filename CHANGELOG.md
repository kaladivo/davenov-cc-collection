...
- New `--update` flag for the CLI that skips confirmation prompts (ideal for updates)
- Update command now uses `--update` flag for smoother experience
- New `/davenov:cc:changelog` command to initialize and manage CHANGELOG.md following Keep a Changelog format
